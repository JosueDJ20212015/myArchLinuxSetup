...
alias wget 'wget -c '
alias cls 'clear'
alias ff='fastfetch --config ~/.config/fastfetch/config.jsonc --logo arch'
#alias fastfetch='fastfetch --config ~/.config/fastfetch/config.jsonc --logo arch'
alias tr 'tree -L'
...
if status --is-interactive && type -q fastfetch
   ...
   #fastfetch --config /usr/share/fastfetch/presets/neofetch.jsonc --logo arch
   fastfetch --config ~/.config/fastfetch/config.jsonc --logo arch
end
